...
class _FakeLoaderBloc_0<Content extends Object> extends _i1.SmartFake
    implements _i2.LoaderBloc<Content> {
  _FakeLoaderBloc_0(Object parent, Invocation parentInvocation)
...
class MockBlocProvider<T extends Object> extends _i1.Mock
  ...
  _i2.LoaderBloc<T> call() => (super.noSuchMethod(Invocation.method(#call, []),
          returnValue: _FakeLoaderBloc_0<T>(this, Invocation.method(#call, [])))
      as _i2.LoaderBloc<T>);
}
  ...
  _i3.Widget call(_i3.BuildContext? context, _i5.LoaderState<T>? state,
      ...
      (super.noSuchMethod(Invocation.method(#call, [context, state, bloc]),
              returnValue: _FakeWidget_1(
                  this, Invocation.method(#call, [context, state, bloc])))
          as _i3.Widget);
}
